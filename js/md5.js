...
(function() {
	var rotateLeft = function(lValue, iShiftBits) {
		...
		var lWordCount, lMessageLength = string.length, lNumberOfWordsTempOne = lMessageLength + 8,
			lNumberOfWordsTempTwo = (lNumberOfWordsTempOne - (lNumberOfWordsTempOne % 64)) / 64,
